...
For high-scalability use cases, try the paid https://docs.timefold.ai/timefold-solver/latest/enterprise-edition/enterprise-edition[Enterprise Edition] instead:
...
[source, shell]
----
$ gradle quarkusDev -Denterprise=true -Dquarkus.profile=enterprise
----
